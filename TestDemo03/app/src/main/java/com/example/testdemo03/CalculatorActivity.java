...
public class CalculatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //下面给每个按钮控件都注册了点击监听器
        findViewById(R.id.btn_cancel).setOnClickListener(this); // “CE”按钮
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_divide:
                ...
                }else Toast.makeText(getApplicationContext(), "请输入正确的算式！", Toast.LENGTH_SHORT).show();
                break;
            //点击了等号按钮
            case R.id.btn_equal:
                /*if (operator.equals("")){
